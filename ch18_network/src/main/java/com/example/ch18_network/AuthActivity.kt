...
import com.example.ch18_network.databinding.ActivityAuthBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.googleLoginBtn.setOnClickListener {
            ...
            val gso = GoogleSignInOptions
                ...
                .requestIdToken("383721805418-nlosnbph4u49t7ms8dnm7ao7jibigp8c.apps.googleusercontent.com")
                .requestEmail()
                .build()
